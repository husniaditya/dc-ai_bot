...
async function initializeTables() {
  ...
  await sqlPool.query(`CREATE TABLE IF NOT EXISTS guild_clashofclans_watch (
    ...
    donation_leaderboard_channel_id VARCHAR(32) NULL,
    ...
    track_donation_leaderboard BOOLEAN NOT NULL DEFAULT 0,
    donation_threshold INT NOT NULL DEFAULT 100,
    donation_leaderboard_schedule VARCHAR(16) NULL DEFAULT 'weekly',
