...
async function initializeTables() {
  ...
  await sqlPool.query(`
  CREATE TABLE IF NOT EXISTS guild_clashofclans_watch (
    id INT(11) NOT NULL AUTO_INCREMENT,
    guild_id VARCHAR(32) NOT NULL,
    clan_tag VARCHAR(20) NOT NULL,
    clan_order INT(11) DEFAULT 0 COMMENT 'Order of clans in UI',
    clans TEXT DEFAULT NULL,
    clan_name VARCHAR(100) DEFAULT NULL COMMENT 'Name of this specific clan',
    war_announce_channel_id VARCHAR(32) DEFAULT NULL,
    member_announce_channel_id VARCHAR(32) DEFAULT NULL,
    donation_announce_channel_id VARCHAR(32) DEFAULT NULL,
    donation_leaderboard_channel_id VARCHAR(32) DEFAULT NULL,
    war_mention_target VARCHAR(512) DEFAULT NULL,
    member_mention_target VARCHAR(512) DEFAULT NULL,
    donation_mention_target VARCHAR(512) DEFAULT NULL,
    donation_message_id VARCHAR(255) DEFAULT NULL COMMENT 'Discord message ID of the donation leaderboard message for updating',
    enabled TINYINT(1) NOT NULL DEFAULT 0,
    interval_sec INT(11) NOT NULL DEFAULT 3600,
    track_wars TINYINT(1) NOT NULL DEFAULT 1,
    track_members TINYINT(1) NOT NULL DEFAULT 1,
    track_donations TINYINT(1) NOT NULL DEFAULT 1,
    track_donation_leaderboard TINYINT(1) NOT NULL DEFAULT 0,
    donation_threshold INT(11) NOT NULL DEFAULT 100,
    donation_leaderboard_schedule VARCHAR(16) DEFAULT 'hourly',
    donation_leaderboard_time VARCHAR(8) DEFAULT '20:00',
    war_start_template TEXT DEFAULT NULL,
    war_end_template TEXT DEFAULT NULL,
    member_join_template TEXT DEFAULT NULL,
    donation_template TEXT DEFAULT NULL,
    donation_leaderboard_template TEXT DEFAULT NULL,
    embed_enabled TINYINT(1) NOT NULL DEFAULT 1,
    clan_data MEDIUMTEXT DEFAULT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    donation_leaderboard_players_per_page INT(11) DEFAULT 20 COMMENT 'Number of players to show per page',
    donation_leaderboard_time_range VARCHAR(16) DEFAULT 'current_season' COMMENT 'Time range for donations (current_season, last_7_days, last_30_days, all_time)',
    donation_leaderboard_interactive TINYINT(1) DEFAULT 1 COMMENT 'Enable interactive controls (refresh, edit, pagination buttons)',
    donation_leaderboard_background_type VARCHAR(16) DEFAULT 'random' COMMENT 'Canvas background type (random, color, gradient, image)',
    donation_leaderboard_primary_color VARCHAR(7) DEFAULT NULL COMMENT 'Primary color for canvas background (hex format)',
    donation_leaderboard_secondary_color VARCHAR(7) DEFAULT NULL COMMENT 'Secondary color for gradient backgrounds (hex format)',
    donation_leaderboard_background_image VARCHAR(512) DEFAULT NULL COMMENT 'URL for custom background image',
    donation_leaderboard_current_page INT(11) DEFAULT 1 COMMENT 'Current page being displayed',
    donation_leaderboard_total_pages INT(11) DEFAULT 1 COMMENT 'Total number of pages available',
    donation_leaderboard_last_update TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Last time leaderboard was updated',
    donation_leaderboard_cached_data MEDIUMTEXT DEFAULT NULL COMMENT 'Cached player data to avoid API rate limits',
    war_leaderboard_cached_data TEXT DEFAULT NULL COMMENT 'Cached war statistics data in JSON format',
    war_leaderboard_channel_id VARCHAR(32) DEFAULT NULL,
    war_leaderboard_message_id VARCHAR(255) DEFAULT NULL,
    clans_backup TEXT DEFAULT NULL COMMENT 'Backup of original comma-separated clans for migration',
    war_current_state VARCHAR(20) DEFAULT 'notInWar' COMMENT 'Current war state: notInWar, preparation, inWar, warEnded',
    war_preparing_message_id VARCHAR(255) DEFAULT NULL COMMENT 'Discord message ID for preparing war canvas',
    war_active_message_id VARCHAR(255) DEFAULT NULL COMMENT 'Discord message ID for active war canvas',
    war_last_state_change TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'When the war state last changed',
    war_state_data LONGTEXT DEFAULT NULL COMMENT 'Additional war state metadata (opponent info, etc)',
    war_ended_message_id VARCHAR(20) DEFAULT NULL,
    war_last_updated DATETIME DEFAULT NULL,
    war_start_time DATETIME DEFAULT NULL,
    war_end_time DATETIME DEFAULT NULL,
    war_opponent_name VARCHAR(255) DEFAULT NULL,
    track_cwl TINYINT(1) DEFAULT 0,
    track_events TINYINT(1) DEFAULT 0 COMMENT 'Enable/disable event tracking (Trader, Raid, Games, Season)',
    events_channel_id VARCHAR(20) DEFAULT NULL COMMENT 'Channel for event announcements',
    events_message_id VARCHAR(20) DEFAULT NULL COMMENT 'Message ID for auto-updating event embed',
    events_state_data TEXT DEFAULT NULL COMMENT 'JSON data storing event states and timers',
    events_last_update DATETIME DEFAULT NULL COMMENT 'Last time events message was updated',
    PRIMARY KEY (id),
    UNIQUE KEY unique_guild_clan (guild_id, clan_tag),
    KEY idx_guild_clashofclans_donation_message (donation_message_id),
    KEY idx_guild_leaderboard_enabled (guild_id, track_donation_leaderboard),
    KEY idx_leaderboard_schedule (donation_leaderboard_schedule, donation_leaderboard_last_update),
    KEY idx_war_leaderboard_channel (war_leaderboard_channel_id),
    KEY idx_clan_tag (clan_tag),
    KEY idx_war_state (guild_id, clan_tag, war_current_state),
    CONSTRAINT war_state_data CHECK (JSON_VALID(war_state_data))
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci
`);
