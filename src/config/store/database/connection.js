...
async function initializeTables() {
  ...
  await sqlPool.query(`
    CREATE TABLE IF NOT EXISTS guild_clashofclans_watch (
      ...
      clan_order INT(11) NULL DEFAULT '0' COMMENT 'Order of clans in UI',
      ...
      donation_leaderboard_players_per_page INT(11) NULL DEFAULT '20' COMMENT 'Number of players to show per page',
      ...
      donation_leaderboard_current_page INT(11) NULL DEFAULT '1' COMMENT 'Current page being displayed',
      donation_leaderboard_total_pages INT(11) NULL DEFAULT '1' COMMENT 'Total number of pages available',
